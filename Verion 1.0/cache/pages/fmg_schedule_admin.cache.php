...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '6164',
      'name' => 'FmgScheduleAdmin',
      'path' => 'packages/fmgame/modules/FmgScheduleAdmin/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '339',
  ...
  'skin' => 'default',
  'help_id' => '0',
  'name' => 'fmg_schedule_admin',
  'title_1' => 'fmg_schedule_admin',
  'title_2' => NULL,
  'description_1' => '',
  'description_2' => '',
  'customer_id' => '0',
...
<body><div class="simple-layout-bound">
	<div class="simple-layout-content">
		<div class="simple-layout-banner"><?php $blocks[73072]['object']->on_draw();?></div>
		<div class="simple-layout-center"><?php $blocks[73073]['object']->on_draw();?></div>
