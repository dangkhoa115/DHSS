...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '6116',
      'name' => 'QuanLyClb',
      'path' => 'packages/backend/modules/QuanLyClb/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '332',
...
<body><div class="simple-layout-bound">
	<div class="simple-layout-content">
		<div class="simple-layout-banner"><?php $blocks[72868]['object']->on_draw();?></div>
		<div class="simple-layout-center"><?php $blocks[72869]['object']->on_draw();?></div>
