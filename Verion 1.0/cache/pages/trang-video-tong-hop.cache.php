...
$blocks = array (
  ...
  array (
    ...
    array (
      ...
      'path' => 'packages/frontend/modules/VideoByCategory/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '331',
  ...
  'skin' => 'default',
  'help_id' => '0',
  'name' => 'trang-video-tong-hop',
  'title_1' => 'trang-video-tong-hop',
  'title_2' => NULL,
  'description_1' => '',
  'description_2' => '',
  'customer_id' => '0',
...
<body><div id="wrapper" <?php echo Portal::get_setting('background')?'style="background:URL('.Portal::get_setting('background').') center 50% fixed no-repeat !important"':'';?>>
	<div class="container">
    <div class="row">
      	<header><?php $blocks[72947]['object']->on_draw();?></header>
        <section class="col-md-12">
        <?php $blocks[72949]['object']->on_draw();?>
        ...
        <?php $blocks[72948]['object']->on_draw();?>
      </div>
    </div>
	</div>
