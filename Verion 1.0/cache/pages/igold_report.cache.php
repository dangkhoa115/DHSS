...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '6148',
      'name' => 'iGoldReport',
      'path' => 'packages/backend/modules/iGoldReport/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '332',
...
<body><div class="simple-layout-bound">
	<div class="simple-layout-content">
		<div class="simple-layout-banner"><?php $blocks[73006]['object']->on_draw();?></div>
		<div class="simple-layout-center"><?php $blocks[73007]['object']->on_draw();?></div>
