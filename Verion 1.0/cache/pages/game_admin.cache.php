...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '6141',
      'name' => 'GameAdmin',
      'path' => 'packages/backend/modules/GameAdmin/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '332',
...
<body><div class="simple-layout-bound">
	<div class="simple-layout-content">
		<div class="simple-layout-banner"><?php $blocks[72981]['object']->on_draw();?></div>
		<div class="simple-layout-center"><?php $blocks[72982]['object']->on_draw();?></div>
