...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '6107',
      'name' => 'NewsCategory',
      'path' => 'packages/frontend/modules/NewsCategory/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'layout' => '',
...
<body><div id="wrapper">
  <div>
<?php $blocks[72800]['object']->on_draw();?></div>
  <div>
<?php $blocks[72803]['object']->on_draw();?></div>
</div>
<div id="footer">
<?php $blocks[72802]['object']->on_draw();?></div><?php echo Portal::get_setting('google_analytics');
