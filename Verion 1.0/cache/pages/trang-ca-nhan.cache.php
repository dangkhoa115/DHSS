...
<body><div class="simple-layout-bound">
	<div class="simple-layout-content">
		<div class="simple-layout-banner"><?php $blocks[71500]['object']->on_draw();?></div>
		<div class="simple-layout-center"><?php $blocks[71503]['object']->on_draw();?></div>
