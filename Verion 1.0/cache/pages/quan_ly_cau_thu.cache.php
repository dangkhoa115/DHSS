...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '6117',
      'name' => 'QuanLyCauThu',
      'path' => 'packages/backend/modules/QuanLyCauThu/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '332',
  ...
  'skin' => 'default',
  'help_id' => '0',
  'name' => 'quan_ly_cau_thu',
  'title_1' => 'quan_ly_cau_thu',
  'title_2' => NULL,
  'description_1' => '',
  'description_2' => '',
  'customer_id' => '0',
...
<body><div class="simple-layout-bound">
	<div class="simple-layout-content">
		<div class="simple-layout-banner"><?php $blocks[72870]['object']->on_draw();?></div>
		<div class="simple-layout-center"><?php $blocks[72871]['object']->on_draw();?></div>
