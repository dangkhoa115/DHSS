...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '6140',
      'name' => 'SsnhBinhChon',
      'path' => 'packages/user/modules/SsnhBinhChon/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '338',
  ...
  'skin' => 'default',
  'help_id' => '0',
  'name' => 'tham-gia-binh-chon',
  'title_1' => 'tham-gia-binh-chon',
  'title_2' => NULL,
  'description_1' => '',
  'description_2' => '',
  'customer_id' => '0',
...
<body><div id="wrapper" <?php echo Portal::get_setting('background')?'style="background:URL('.Portal::get_setting('background').') center 50% fixed no-repeat !important"':'';?>>
	<div class="container">
    <div class="row">
      	<header><?php $blocks[72974]['object']->on_draw();?></header>
        ...
        <?php }?>
        <div class="row">
        <div class="col-left col-md-9"><?php $blocks[72976]['object']->on_draw();?></div> <!-- End .col-left -->
        <div class="col-right col-md-3"><?php $blocks[72977]['object']->on_draw();?><?php $blocks[73063]['object']->on_draw();?><?php $blocks[73062]['object']->on_draw();?></div> <!-- End .col-right -->
        </div>
        <?php if(Url::get('page')=='clb' or Url::get('page')=='cau-thu'){?>
        </div> <!-- End .container -->
        <?php }?>
        ...
        <?php $blocks[72975]['object']->on_draw();?>
      </div>
    </div>
	</div>
