...
<body><div class="simple-layout-bound">
	<div class="simple-layout-content">
		<div class="simple-layout-banner"><?php $blocks[71448]['object']->on_draw();?></div>
		<div class="simple-layout-center"><?php $blocks[71450]['object']->on_draw();?></div>
