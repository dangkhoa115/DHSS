...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '6155',
      'name' => 'QuanLyItems',
      'path' => 'packages/user/modules/QuanLyItems/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '338',
...
<body><div class="simple-layout-bound">
	<div class="simple-layout-content">
		<div class="simple-layout-banner"><?php $blocks[73021]['object']->on_draw();?></div>
		<div class="simple-layout-center"><?php $blocks[73022]['object']->on_draw();?></div>
