...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '6130',
      'name' => 'SsnhNguoiChoi',
      'path' => 'packages/user/modules/SsnhNguoiChoi/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '338',
  ...
  'package_id' => '338',
  'layout_id' => '0',
  'layout' => 'packages/frontend/layouts/tong_hop.php',
  'skin' => 'default',
  'help_id' => '0',
  'name' => 'tong-hop',
  'title_1' => 'tong-hop',
...
<body><div id="wrapper" <?php echo Portal::get_setting('background')?'style="background:URL('.Portal::get_setting('background').') center 50% fixed no-repeat !important"':'';?>>
	<div class="container">
  <div class="row">
    <header><?php $blocks[72914]['object']->on_draw();?></header>
    <section class="col-md-12">
      <div class="row">
        <div class="col-md-6"><?php $blocks[72916]['object']->on_draw();?></div> <!-- End .col-left -->
        <div class="col-md-6"><?php $blocks[72917]['object']->on_draw();?></div> <!-- End .col-right -->
      </div>
    	      
     </section>
    <div class="col-md-12 footer">
      <?php $blocks[72915]['object']->on_draw();?>
    </div>
   </div>
