...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '6124',
      'name' => 'HomeNews',
      'path' => 'packages/frontend/modules/HomeNews/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '331',
  ...
  array (
    ...
    array (
      'id' => '6123',
      'name' => 'SsnhCauThuXuatSacNhat',
      'path' => 'packages/frontend/modules/SsnhCauThuXuatSacNhat/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '331',
  ...
  array (
    ...
    array (
      'id' => '6100',
      'name' => 'HomeSlide',
      'path' => 'packages/frontend/modules/HomeSlide/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '331',
...
<?php }?>
  ...
  array (
    ...
    'page_id' => '10302',
    'container_id' => '72241',
    'region' => 'top_banner_adv_02',
    'position' => '1',
    'skin_name' => 'default',
    'layout' => 'default',
    'name' => 'top_banner_adv_02',
    'settings' => 
    array (
      '5911_cache' => '<div class="frontend-advertisment-default"><div class="advertisment-bound" style=" <?php if(Module::get_setting(\'extend_css\')){ echo Module::get_setting(\'extend_css\'); }?>">
<?php
...
<body><div id="wrapper" <?php echo Portal::get_setting('background')?'style="background:URL('.Portal::get_setting('background').') center 50% fixed no-repeat !important"':'';?>>
	<div class="container">
    <div class="row">
      	<header><?php $blocks[72241]['object']->on_draw();?></header>
        <section class="col-md-12">
        <?php $blocks[72884]['object']->on_draw();?><?php $blocks[72881]['object']->on_draw();?>
        <?php if(Url::get('page')=='clb' or Url::get('page')=='cau-thu'){?>
        <div class="player">
        <?php }?>
        <div class="row">
        <div class="col-left col-md-9"><?php $blocks[72883]['object']->on_draw();?></div> <!-- End .col-left -->
        <div class="col-right col-md-3"><?php $blocks[72882]['object']->on_draw();?></div> <!-- End .col-right -->
        </div>
        <?php if(Url::get('page')=='clb' or Url::get('page')=='cau-thu'){?>
        </div> <!-- End .container -->
        <?php }?>
        ...
        <?php $blocks[72251]['object']->on_draw();?>
      </div>
    </div>
	</div>
