...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '5933',
      'name' => 'Utils',
      'path' => 'packages/backend/modules/Utils/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '332',
...
<body><div class="simple-layout-bound">
	<div class="simple-layout-content">
		<div class="simple-layout-banner"><?php $blocks[71567]['object']->on_draw();?></div>
		<div class="simple-layout-center"><?php $blocks[71569]['object']->on_draw();?></div>
