...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '6147',
      'name' => 'iGoldLog',
      'path' => 'packages/user/modules/iGoldLog/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '338',
...
<body><div id="wrapper" <?php echo Portal::get_setting('background')?'style="background:URL('.Portal::get_setting('background').') center 50% fixed no-repeat !important"':'';?>>
	<div class="container">
    <div class="row">
      	<header><?php $blocks[73002]['object']->on_draw();?></header>
        ...
        <?php }?>
        <div class="row">
        <div class="col-left col-md-9"><?php $blocks[73005]['object']->on_draw();?></div> <!-- End .col-left -->
        <div class="col-right col-md-3"><?php $blocks[73004]['object']->on_draw();?></div> <!-- End .col-right -->
        </div>
        <?php if(Url::get('page')=='clb' or Url::get('page')=='cau-thu'){?>
        </div> <!-- End .container -->
        <?php }?>
        ...
        <?php $blocks[73003]['object']->on_draw();?>
      </div>
    </div>
	</div>
