...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '5927',
      'name' => 'CurrencyAdmin',
      'path' => 'packages/backend/modules/CurrencyAdmin/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '332',
...
<body><div class="simple-layout-bound">
	<div class="simple-layout-content">
		<div class="simple-layout-banner"><?php $blocks[71548]['object']->on_draw();?></div>
		<div class="simple-layout-center"><?php $blocks[71550]['object']->on_draw();?></div>
