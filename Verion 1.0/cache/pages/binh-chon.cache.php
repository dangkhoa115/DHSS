...
<body><div id="wrapper" <?php echo Portal::get_setting('background')?'style="background:URL('.Portal::get_setting('background').') center 50% fixed no-repeat !important"':'';?>>
	<div class="container">
    <div class="row">
      	<header><?php $blocks[72919]['object']->on_draw();?></header>
        ...
        <?php }?>
        <div class="row">
        <div class="col-left col-md-9"><?php $blocks[72922]['object']->on_draw();?></div> <!-- End .col-left -->
        <div class="col-right col-md-3"><?php $blocks[72921]['object']->on_draw();?></div> <!-- End .col-right -->
        </div>
        <?php if(Url::get('page')=='clb' or Url::get('page')=='cau-thu'){?>
        </div> <!-- End .container -->
        <?php }?>
        ...
        <?php $blocks[72920]['object']->on_draw();?>
      </div>
    </div>
	</div>
