...
$blocks = array (
  ...
  'skin' => 'default',
  'help_id' => '0',
  'name' => 'top-50-binh-chon',
  'title_1' => 'top-50-binh-chon',
  'description_1' => '',
  'description' => '',
  'customer_id' => '0',
  'read_only' => '0',
...
<body><div id="wrapper" <?php echo Portal::get_setting('background')?'style="background:URL('.Portal::get_setting('background').') center 50% fixed no-repeat !important"':'';?>>
	<div class="container">
    <div class="row">
      	<header><?php $blocks[72964]['object']->on_draw();?></header>
        ...
        <?php }?>
        <div class="row">
        <div class="col-left col-md-9"><?php $blocks[72966]['object']->on_draw();?></div> <!-- End .col-left -->
        <div class="col-right col-md-3"><?php $blocks[72993]['object']->on_draw();?></div> <!-- End .col-right -->
        </div>
        <?php if(Url::get('page')=='clb' or Url::get('page')=='cau-thu'){?>
        </div> <!-- End .container -->
        <?php }?>
