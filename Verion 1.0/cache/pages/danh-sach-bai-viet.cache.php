...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '6144',
      'name' => 'SsnhDangTin',
      'path' => 'packages/frontend/modules/SsnhDangTin/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '331',
...
<body><div id="wrapper" <?php echo Portal::get_setting('background')?'style="background:URL('.Portal::get_setting('background').') center 50% fixed no-repeat !important"':'';?>>
	<div class="container">
    <div class="row">
      	<header><?php $blocks[73008]['object']->on_draw();?></header>
        ...
        <?php }?>
        <div class="row">
        <div class="col-left col-md-9"><?php $blocks[73011]['object']->on_draw();?></div> <!-- End .col-left -->
        <div class="col-right col-md-3"><?php $blocks[73010]['object']->on_draw();?></div> <!-- End .col-right -->
        </div>
        <?php if(Url::get('page')=='clb' or Url::get('page')=='cau-thu'){?>
        </div> <!-- End .container -->
        <?php }?>
        ...
        <?php $blocks[73009]['object']->on_draw();?>
      </div>
    </div>
	</div>
