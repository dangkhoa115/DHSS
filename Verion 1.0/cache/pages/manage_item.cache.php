...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '6076',
      'name' => 'ManageItem',
      'path' => 'packages/backend/modules/ManageItem/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '1',
      'package_id' => '332',
...
<body><div class="simple-layout-bound">
	<div class="simple-layout-content">
		<div class="simple-layout-banner"><?php $blocks[72727]['object']->on_draw();?></div>
		<div class="simple-layout-center"><?php $blocks[72728]['object']->on_draw();?></div>
