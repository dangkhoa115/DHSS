...
<body><div class="simple-layout-bound">
	<div class="simple-layout-content">
		<div class="simple-layout-banner"><?php $blocks[72905]['object']->on_draw();?></div>
		<div class="simple-layout-center"><?php $blocks[72907]['object']->on_draw();?></div>
