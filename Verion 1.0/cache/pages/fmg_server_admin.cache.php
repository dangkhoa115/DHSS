...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '6165',
      'name' => 'FmgServerAdmin',
      'path' => 'packages/fmgame/modules/FmgServerAdmin/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '339',
  ...
  'skin' => 'default',
  'help_id' => '0',
  'name' => 'fmg_server_admin',
  'title_1' => 'fmg_server_admin',
  'title_2' => NULL,
  'description_1' => '',
  'description_2' => '',
  'customer_id' => '0',
...
<body><div id="wrapper">
    ...
    <div class="row fm-game">
      	<header><?php $blocks[73081]['object']->on_draw();?></header>
        <section class="col-md-12">
        <?php $blocks[73080]['object']->on_draw();?>
      	</section>
