...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '6139',
      'name' => 'SsnhVanTatNguoiChoi',
      'path' => 'packages/user/modules/SsnhVanTatNguoiChoi/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '338',
  ...
  array (
    ...
    array (
      'id' => '6132',
      'name' => 'SsnhBangXepHangNguoiChoi',
      'path' => 'packages/user/modules/SsnhBangXepHangNguoiChoi/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '338',
  ...
  'skin' => 'default',
  'help_id' => '0',
  'name' => 'bang-xep-hang-nguoi-choi',
  'title_1' => 'bang-xep-hang-nguoi-choi',
  'title_2' => NULL,
  'description_1' => '',
  'description_2' => '',
  'customer_id' => '0',
...
<body><div id="wrapper" <?php echo Portal::get_setting('background')?'style="background:URL('.Portal::get_setting('background').') center 50% fixed no-repeat !important"':'';?>>
	<div class="container">
    <div class="row">
      	<header><?php $blocks[72923]['object']->on_draw();?></header>
        ...
        <?php }?>
        <div class="row">
        <div class="col-left col-md-9"><?php $blocks[72926]['object']->on_draw();?></div> <!-- End .col-left -->
        <div class="col-right col-md-3"><?php $blocks[72962]['object']->on_draw();?><?php $blocks[72963]['object']->on_draw();?></div> <!-- End .col-right -->
        </div>
        <?php if(Url::get('page')=='clb' or Url::get('page')=='cau-thu'){?>
        </div> <!-- End .container -->
        <?php }?>
        ...
        <?php $blocks[72924]['object']->on_draw();?>
      </div>
    </div>
	</div>
