...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '5902',
      'name' => 'NewsAdmin',
      'path' => 'packages/backend/modules/NewsAdmin/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '332',
...
<body><div class="simple-layout-bound">
	<div class="simple-layout-content">
		<div class="simple-layout-banner"><?php $blocks[71458]['object']->on_draw();?></div>
		<div class="simple-layout-center"><?php $blocks[71460]['object']->on_draw();?></div>
