...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '6143',
      'name' => 'GameList',
      'path' => 'packages/frontend/modules/GameList/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '331',
...
<body><div id="wrapper" <?php echo Portal::get_setting('background')?'style="background:URL('.Portal::get_setting('background').') center 50% fixed no-repeat !important"':'';?>>
	<div class="container">
    <div class="row">
      	<header><?php $blocks[72986]['object']->on_draw();?></header>
        ...
        <?php }?>
        <div class="row">
        <div class="col-left col-md-9"><?php $blocks[72988]['object']->on_draw();?></div> <!-- End .col-left -->
        ...
        <?php $blocks[72987]['object']->on_draw();?>
      </div>
    </div>
	</div>
