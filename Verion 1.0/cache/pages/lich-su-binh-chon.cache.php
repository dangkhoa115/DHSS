...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '6132',
      'name' => 'SsnhQuanLyBinhChon',
      'path' => 'packages/backend/modules/SsnhQuanLyBinhChon/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '332',
  ...
  'skin' => 'default',
  'help_id' => '0',
  'name' => 'lich-su-binh-chon',
  'title_1' => 'lich-su-binh-chon',
  'description_1' => '',
  'description' => '',
  'customer_id' => '0',
  'read_only' => '0',
...
<body><div class="simple-layout-bound">
	<div class="simple-layout-content">
		<div class="simple-layout-banner"><?php $blocks[72920]['object']->on_draw();?></div>
		<div class="simple-layout-center"><?php $blocks[72921]['object']->on_draw();?></div>
