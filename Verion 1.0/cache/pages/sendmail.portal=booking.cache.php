...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '6159',
      'name' => 'SendEmail',
      'path' => 'packages/backend/modules/SendEmail/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '332',
...
<body><div class="simple-layout-bound">
	<div class="simple-layout-content">
		<div class="simple-layout-banner"><?php $blocks[73056]['object']->on_draw();?></div>
		<div class="simple-layout-center"><?php $blocks[73055]['object']->on_draw();?></div>
