...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '6129',
      'name' => 'Video',
      'path' => 'packages/frontend/modules/Video/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '331',
  ...
  'package_id' => '331',
  'layout_id' => '0',
  'layout' => 'packages/frontend/layouts/video.php',
  'skin' => 'default',
  'help_id' => '0',
  'name' => 'video',
  'title_1' => 'video',
...
<body><div id="wrapper" <?php echo Portal::get_setting('background')?'style="background:URL('.Portal::get_setting('background').') center 50% fixed no-repeat !important"':'';?>>
	<div class="container">
  <div class="row">
    <header><?php $blocks[72893]['object']->on_draw();?></header>
    <article>
      <section class="col-md-12">
        <?php $blocks[72913]['object']->on_draw();?>
       </section>
    </article>
    <div class="col-md-12 footer">
      <?php $blocks[72894]['object']->on_draw();?>
    </div>
   </div>
