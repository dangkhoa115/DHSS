    ...
    <div class="row">
        ...
        <form name="SignInForm" id="SignInForm" method="post">
            ...
            <div class="manipulation">
                <div class="col-l">
                    <input  name="save_password" id="save_password" value="1" / type ="checkbox" value="<?php echo String::html_normalize(URL::get('save_password'));?>"> <span class="remember-pass">Ghi nhớ tài khoản</span>
                </div>
                <div class="col-r">
