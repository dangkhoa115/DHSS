<fieldset id="toolbar">
	...
	<table align="right">
	  <tbody>
		...
		<?php if(User::is_login()){?><td id="toolbar-config"  align="center"><a href="<?php echo Url::build_current();?>"> <span title="<?php echo Portal::language('information');?>"></span><?php echo Portal::language('Information');?></a> </td><?php }?>
		</tr>
	  </tbody>
	</table>
	</div>
