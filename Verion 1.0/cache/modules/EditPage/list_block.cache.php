<table width="100%"  border="0" cellpadding="3" bgcolor="#FFFFFF" 
  ...
  <tr valign="top">
    <td>
	<?php echo Draw::begin_round_table();?>	<span style="text-transform:uppercase;color:#000066">&nbsp;&nbsp;::&nbsp;&nbsp;&nbsp;<b><?php echo $this->map['name'];?></b>&nbsp;&nbsp;&nbsp;&nbsp;::</span>
	<fieldset>
		...
		<table width="100%" border="0" cellpadding="3" cellspacing="0">
            ...
            <tr valign="top" <?php echo Draw::hover('#CCCCCC');?>>
              ...
              <td align="left" valign="top" nowrap><strong><a href="<?php echo $this->map['items']['current']['href'];?>" ondragstart="event.dataTransfer.setData('Text', '<?php echo $this->map['items']['current']['id'];?>');event.dataTransfer.effectAllowed = 'copy'; "><?php echo $this->map['items']['current']['name'];?><?php 
				...
				?></a>&nbsp;&nbsp;&nbsp;</strong></td>
              <td valign="top"><a href="<?php echo URL::build_current(array('cmd'=>'delete'));?>&id=<?php echo $this->map['items']['current']['id'];?>"><strong><img src="skins/default/images/buttons/delete.gif" width="12" height="12" border="0" ></strong></a></td>
...
<?php echo Draw::end_round_table();?></td></tr>
    </table>
