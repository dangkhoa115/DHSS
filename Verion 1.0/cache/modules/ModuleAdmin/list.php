...
<table cellpadding="0" width="100%"><tr><td  class="form_title"><img src="skins/default/images/buttons/<?php echo $action;?>_button.gif" align="absmiddle" alt=""/><?php echo $title;?></td><?php 
		if(URL::get('cmd')=='delete'){?><td class="form_title_button"><a  onclick="ListModuleAdminForm.submit();"><img src="skins/default/images/buttons/delete_button.gif" style="text-align:center" alt=""/><br /><?php echo Portal::language('Delete');?></a></td>
	...
	<td class="form_title_button"><a href="<?php echo URL::build_current(array('cmd'=>'delete_cache'));?>"><img src="skins/default/images/buttons/delete_cache_button.gif" style="text-align:center"/><br /><?php echo Portal::language('delete_module_cache');?></a></td><?php }?><?php 
		...
		if(User::can_delete()){?>
	<td class="form_title_button"><a  onclick="ListModuleAdminForm.cmd.value='delete';ListModuleAdminForm.submit();"><img src="skins/default/images/buttons/delete_button.gif" alt=""/><br />
		...
		<td width="100%">
			...
			<tr>
				<td width="100%">
                    ...
                    (<?php echo Portal::language('total');?> <strong><?php echo $this->map['total'];?></strong> modules)
