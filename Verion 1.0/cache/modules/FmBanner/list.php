...
<div class="row">
    ...
    <div class="row">
   	 <div class="col-xs-12">
          ...
          <div class="col-xs-8">
            <div class="left">
            <a class="logo" href="/" title="FANTASY PHONG CÁCH VIỆT / Bản thử ngiệm"><img src="starteam/images/logo.png" height="40px" alt="ĐỘI HÌNH SIÊU SAO"> ĐỘI HÌNH SIÊU SAO <span class="glyphicon glyphicon-star" aria-hidden="true"></span><span class="glyphicon glyphicon-star" aria-hidden="true"></span><span class="glyphicon glyphicon-star" aria-hidden="true"></span><span class="glyphicon glyphicon-star" aria-hidden="true"></span><span class="glyphicon glyphicon-star" aria-hidden="true"></span></a>
            <!--<div
              class="fb-like"
              data-share="true"
              data-width="80"
          ...
          <div class="col-xs-4 text-right">
            <div class="dropdown" style="float:right;">
                ...
                HLV: <strong><?php echo $this->map['full_name'];?></strong>
                <span class="caret"></span>
              </button>
              <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                <li> <a href="trang-ca-nhan-dhss.html">ID: <?php echo Session::get('user_id');?></a></li>
                <li><a href="trang-ca-nhan-dhss.html" class="username">HLV: <strong><?php echo $this->map['full_name'];?></strong></a></li>
                <li><a href="nap_igold_dhss.html" class="shop">Nạp iGold</a></li>
                <li><a href="?page=fmg_shop" class="shop">SHOP</a></li>
                <li><a href="thoat.html?href=dhss-dang-nhap.html" class="log-out">Thoát</a></li>
              </ul>
           </div>
						<div class="user-name">
            	<a href="?page=nhan-thuong">Nhận thưởng</a>
           		<a href="tin-nhan.html" class="message <?php echo $this->map['number_message']?'unread':'';?>" title="<?php echo $this->map['new_message'];?>"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> <span id="message" class="badge"><?php echo $this->map['number_message'];?></span></a>
             	<a href="nap_igold_dhss.html" class="igold"><span id="igold1"><?php echo iGold::get_igold(Session::get('user_id'));?></span> iGold</a>
            </div>
          </div>
      	</div>
        ...
        <?php 
				if((Url::get('page')!='nap_igold_dhss'))
				{?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="color:#000;">
          ...
          <li>Sẽ có phần thưởng hấp dẫn hàng tháng cho TOP HLV trong tháng</li>
        </ul>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
...
<?php 
				if((!$this->map['da_dang_ky_giai_phu']))
				{?>
...
<?php if(1>1 and (FMGAME::my_team_id() == true and User::is_login() and !$this->map['da_dang_ky_giai_phu'] and (!Url::get('page') or Url::get('page')=='fmg_team'))){?>
