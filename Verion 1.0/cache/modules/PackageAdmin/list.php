...
<table cellpadding="0" width="100%"><tr valign="bottom"><td  class="form_title"><img src="skins/default/images/buttons/<?php echo $action;?>_button.gif" align="absmiddle" alt=""/><?php echo $title;?></td><?php 
	if(URL::get('cmd')=='delete'){?><td class="form_title_button"><a  onclick="ListPackageAdminForm.submit();"><img src="skins/default/images/buttons/delete_button.gif" style="text-align:center" alt=""/><br /><?php echo Portal::language('Delete');?></a></td>
	<td class="form_title_button"><a href="<?php echo URL::build_current(array('name'=>isset($_GET['name'])?$_GET['name']:''));?>"><img src="skins/default/images/buttons/go_back_button.gif" style="text-align:center" alt=""/><br /><?php echo Portal::language('back');?></a></td><?php }
	else{ if(User::can_add()){?><td class="form_title_button"><a href="<?php echo URL::build_current(array(	'name'=>isset($_GET['name'])?$_GET['name']:'')+array('cmd'=>'add'));?>"><img src="skins/default/images/buttons/add_button.gif" style="text-align:center" alt=""/><br /><?php echo Portal::language('Add');?></a></td><?php }?><?php 
	if(User::can_edit()){?><td class="form_title_button"><a href="<?php echo URL::build_current(array('cmd'=>'make_library_cache'));?>"><img src="skins/default/images/buttons/make_cache_button.gif" style="text-align:center"/><br /><?php echo Portal::language('make_cache');?></a></td>
	...
	if(User::can_delete()){?><td class="form_title_button">
				<a  onclick="ListPackageAdminForm.cmd.value='delete';ListPackageAdminForm.submit();"><img src="skins/default/images/buttons/delete_button.gif" alt=""/><br /><?php echo Portal::language('Delete');?></a></td><?php }}?>
					...
					if(isset($this->map['items']) and is_array($this->map['items']))
					{
						...
						<tr bgcolor="<?php if((URL::get('just_edited_id',0)==$this->map['items']['current']['id']) or (is_numeric(array_search($this->map['items']['current']['id'],$this->map['just_edited_ids'])))){ echo '#EFFFDF';} else {echo 'white';}?>" valign="middle" <?php Draw::hover('#E2F1DF');?> style="cursor:pointer;" id="PackageAdmin_tr_<?php echo $this->map['items']['current']['id'];?>">
							...
							<td nowrap align="left" onclick="location='<?php echo URL::build_current();?>&cmd=edit&id=<?php echo $this->map['items']['current']['id'];?>';">
								...
								</td><td nowrap align="left" onclick="location='<?php echo URL::build_current();?>&cmd=edit&id=<?php echo $this->map['items']['current']['id'];?>';">
	...
	'name'=>isset($_GET['name'])?$_GET['name']:'', 
	  )+array('cmd'=>'edit','id'=>$this->map['items']['current']['id'])); ?>"><img src="skins/default/images/buttons/edit.gif" alt="<?php echo Portal::language('Edit');?>" width="12" height="12" border="0"></td></a>
							<?php
							}
...
<?php 
			...
			<td>
				<a name="bottom_anchor" ><img src="skins/default/images/top.gif" title="<?php echo Portal::language('top');?>" border="0" alt="<?php echo Portal::language('top');?>"></a>
			</td>
			</tr></table>
