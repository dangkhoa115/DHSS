    ...
    <div class="svd">
        ...
        <div id="BangKetQua">
          	...
          	<div class="col-md-6 left">
            	<h3><span class="logo"><img src="<?php echo $this->map['cn_logo'];?>" width="50" height="50"></span><?php echo $this->map['cn_ten'];?></h3>
            ...
            <div class="col-md-6 right">
            	<h3><span class="logo"><img src="<?php echo $this->map['kh_logo'];?>" width="50" height="50"></span><?php echo $this->map['kh_ten'];?></h3>
