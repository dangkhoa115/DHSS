	...
	<table align="right">
	  <tbody>
		<tr>
		  ...
		  <td id="toolbar-save"  align="center"><a onclick="EditGameAdmin.submit();"> <span title="Edit"> </span> <?php echo Portal::language('Save');?> </a> </td>
...
<fieldset id="toolbar">
	...
	<form name="EditGameAdmin" id="EditGameAdmin" method="post" enctype="multipart/form-data">
	    ...
	    <table cellpadding="4" cellspacing="0" border="0" width="100%" style="background-color:#F9F9F9;border:1px solid #D5D5D5">
					...
					if(isset($this->map['languages']) and is_array($this->map['languages']))
					{
						...
						<div class="tab-page" id="tab-page-category-<?php echo $this->map['languages']['current']['id'];?>">
							...
							<div class="form_input">
								 <input  name="name_<?php echo $this->map['languages']['current']['id'];?>" id="name_<?php echo $this->map['languages']['current']['id'];?>" style="width:60%;border:1px solid #CCCCCC;"  / type ="text" value="<?php echo String::html_normalize(URL::get('name_'.$this->map['languages']['current']['id']));?>">
							</div>
							<div class="form_input_label">Giới thiệu</div>
							<div class="form_input">
							...
							<div class="form_input_label">Mã game</div>
							<div class="form_input">
            ...
            <tr>
							<td align="center" colspan="2"><a href="#" onClick="window.open('?page=file_manager','Quan ly thu vien anh','width=850,height=500,left=480');return false;">Quản lý thư viện ảnh</a></td>
						</tr>					
					</table>
					</div>
					<div id="panel_1" style="margin-top:8px;">
					...
					<table cellpadding="4" cellspacing="0" width="100%" border="1" bordercolor="#E9E9E9" style="margin-top:2px;">
						<tr>
						  ...
						  <td width="51%" align="left"><input  name="author" id="author" class="input" type ="text" value="<?php echo String::html_normalize(URL::get('author'));?>"></td>
						</tr>
						<tr>
						...
						<tr>
							<td width="49%" align="right"><?php echo Portal::language('front_page');?></td>
						  <td width="51%" align="left"><select  name="front_page" id="front_page" class="select"><?php
					if(isset($this->map['front_page_list']))
					{
						foreach($this->map['front_page_list'] as $key=>$value)
						{
							echo '<option value="'.$key.'"';
							echo '>'.$value.'</option>';
					...
					?><script type="text/javascript">getId('front_page').value = "<?php echo addslashes(URL::get('front_page',isset($this->map['front_page'])?$this->map['front_page']:''));?>";</script>
	</select></td>
						</tr>
						<tr>
					...
					<table cellpadding="4" cellspacing="0" width="100%" border="1" bordercolor="#E9E9E9">
						<tr>
						  ...
						  <td width="70%" align="left"><input  name="keywords" id="keywords" class="input-large" type ="text" value="<?php echo String::html_normalize(URL::get('keywords'));?>"></td>
						</tr>	
						<tr>
