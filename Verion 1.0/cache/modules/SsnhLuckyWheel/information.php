...
<?php }elseif(Url::get('page') == 'top-50-binh-chon'){?>
<div style="float:left;width:100%;min-height:300px;">
<? }else{?>
<div style="float:left;width:100%;min-height:300px;">
<?php }?>
  <div class="tab-pane-1">
    <div class="tab-page">
      <h2 class="tab">Bình chọn của người chơi</h2>
      ...
      <?php 
				...
				{?>
      <select  name="search_clb_id" id="search_clb_id" onchange="EditQuanLyLichSuCauThuForm.submit()"><?php
