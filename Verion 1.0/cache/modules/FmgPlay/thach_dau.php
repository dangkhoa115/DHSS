  ...
  <div class="col-xs-12 ket-qua-tran-dau">
    ...
    <div class="svd">
        <div class="col-xs-6" id="doi_chu_nha">
        	...
        	<?php echo ($this->map['kq']=='Hòa')?'<div class="hoa">Hòa</div>':(($this->map['kq']=='Thắng')?'<div class="win"><img src="skins/ssnh/images/fm_game/win.png" alt="Winner"></div>':'');?>
            ...
            <?php
              ...
              <td>
                  <div class="m-player-o">
                      <div class="img"><img src="https://sieusaongoaihang.vn/<?php echo $this->map['cn_thu_mon']['current']['anh_dai_dien'];?>"/></div>
          ...
          <table class="col">
              ...
              <tr valign="middle"><td>
                  <div class="m-player-o">
                      <div class="img"><img src="https://sieusaongoaihang.vn/<?php echo $this->map['cn_hau_ve']['current']['anh_dai_dien'];?>"/></div>
           ...
           <table class="col">
             <?php
              ...
              <tr><td>
                  <div class="m-player-o">
                      <div class="img"><img src="https://sieusaongoaihang.vn/<?php echo $this->map['cn_tien_ve']['current']['anh_dai_dien'];?>"/></div>
         ...
         <table class="col">
              ...
              <tr><td>
                  <div class="m-player-o">
                      <div class="img"><img src="https://sieusaongoaihang.vn/<?php echo $this->map['cn_tien_dao']['current']['anh_dai_dien'];?>"/></div>
        ...
        <div class="col-xs-6" id="doi_khach">
        	...
        	<table class="col">
              ...
              <tr><td>
                  <div class="m-player-o">
                      <div class="img"><img src="skins/ssnh/images/fm_game/hidden_player.png"></div>
                      <span class="nub"><?php echo $this->map['kh_tien_dao']['current']['so_ao'];?></span>
                      <p class="text">
                          <span class="name"> Ẩn danh </span>
                      </p>
...
<?php 
  ...
  jQuery('#progress_bar .ui-progress').animateProgress($per, function() {
		...
		clearInterval(jt);
   	<?php 
				if(($this->map['thach_dau']==false))
				{?>
		window.document.location = '<?php echo Url::build_current(array('do','dcn_id','dkh_id','vong_dau_id'));?>';
