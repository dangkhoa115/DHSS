...
<table cellpadding="0" width="100%"><tr><td  class="form_title"><img src="skins/default/images/buttons/<?php echo $action;?>_button.gif" align="absmiddle" alt=""/><?php echo $title;?></td><?php if(URL::get('cmd')=='delete'){?><td class="form_title_button"><a  onclick="ListPageAdminForm.submit();"><img src="skins/default/images/buttons/delete_button.gif" alt="" width="20" height="20" style="text-align:center"/><br />
  <?php echo Portal::language('Delete');?></a></td><td class="form_title_button"><a href="<?php echo URL::build_current(array('portal_id','package_id'=>isset($_GET['package_id'])?$_GET['package_id']:'', 'name'=>isset($_GET['name'])?$_GET['name']:''));?>"><img src="skins/default/images/buttons/go_back_button.gif" style="text-align:center" alt=""/><br /><?php echo Portal::language('back');?></a></td><?php }else{ 
		...
		if(User::can_add()){?><td class="form_title_button"><a href="<?php echo URL::build_current(array('portal_id','package_id'=>isset($_GET['package_id'])?$_GET['package_id']:'', 'name'=>isset($_GET['name'])?$_GET['name']:'')+array('cmd'=>'add'));?>"><img src="skins/default/images/buttons/add_button.gif" style="text-align:center" alt=""/><br /><?php echo Portal::language('Add');?></a></td><td class="form_title_button" align="center"><a href="<?php echo URL::build_current(array('portal_id','package_id'=>isset($_GET['package_id'])?$_GET['package_id']:'', 'name'=>isset($_GET['name'])?$_GET['name']:'')+array('cmd'=>'add_blocks'));?>"><img src="skins/default/images/buttons/add.jpg" style="text-align:center" alt=""/><br /><?php echo Portal::language('Add_block');?></a></td><?php }?><?php if(User::can_delete()){?><td class="form_title_button">
				<a  onclick="ListPageAdminForm.cmd.value='delete';ListPageAdminForm.submit();"><img src="skins/default/images/buttons/delete_button.gif" alt=""/><br /><?php echo Portal::language('Delete');?></a></td><?php }}?>
