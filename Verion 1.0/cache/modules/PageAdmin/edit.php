...
<table cellpadding="0" width="100%"><tr><td  class="form_title"><img src="skins/default/images/buttons/<?php echo $action;?>_button.gif" align="absmiddle" alt=""/><?php echo $title;?></td><td class="form_title_button"><a onclick="EditPageAdminForm.submit();"><img src="skins/default/images/buttons/save_button.gif" style="text-align:center"/><br /><?php echo Portal::language('save');?></a></td><td>&nbsp;</td>
		<td class="form_title_button">
			<a onclick="location='<?php echo URL::build_current(array('portal_id','package_id'));?>';"><img src="skins/default/images/buttons/go_back_button.gif"/><br /><?php echo Portal::language('back');?></a></td>
		<?php if($action=='edit'){?><td class="form_title_button">
			<a onclick="location='<?php echo URL::build_current(array('portal_id','package_id','cmd'=>'delete','id'));?>';"><img src="skins/default/images/buttons/delete_button.gif" alt=""/><br /><?php echo Portal::language('Delete');?></a></td><?php }?>
		<td class="form_title_button">
	...
	<table cellspacing="0" width="100%"><tr><td>
		...
		<div class="form_input">
			<select  name="layout" id="layout"><?php
					...
					?><script type="text/javascript">getId('layout').value = "<?php echo addslashes(URL::get('layout',isset($this->map['layout'])?$this->map['layout']:''));?>";</script>
	</select>
        ...
        <div class="form_input_label"><?php echo Portal::language('cachable');?>:</div>
		<div class="form_input">
