...
<div align="center">
<form name="EditQuanLyItemsForm" method="post" enctype="multipart/form-data">
	...
	<tr valign="top" bgcolor="#FFFFFF">
        ...
        <table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
            <tr>
                ...
                <?php if(User::can_add(false,ANY_CATEGORY)){?><td width="1%"><a href="javascript:void(0)" onclick="EditQuanLyItemsForm.submit();" class="button-medium-save">Ghi</a></td><?php }?>
