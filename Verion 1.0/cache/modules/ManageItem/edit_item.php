...
<fieldset id="toolbar">
 	<div id="toolbar-title">
		<?php echo Portal::language('edit_item');?> <span style="font-size:16px;color:#0B55C4;">[ <?php echo Portal::language(Url::get('cmd','list'));?> ]</span>
	</div>
...
<fieldset id="toolbar">
	...
	<form name="EditItemAdmin" id="EditItemAdmin" method="post" enctype="multipart/form-data">
	    ...
	    <table cellpadding="4" cellspacing="0" border="0">
            ...
            <td align="left"><select  name="model_id" id="model_id" class="select-large"><?php
					if(isset($this->map['model_id_list']))
					{
						foreach($this->map['model_id_list'] as $key=>$value)
						{
							echo '<option value="'.$key.'"';
							echo '>'.$value.'</option>';
					...
					?><script type="text/javascript">getId('model_id').value = "<?php echo addslashes(URL::get('model_id',isset($this->map['model_id'])?$this->map['model_id']:''));?>";</script>
	
            </select></td>
            </tr>
					<tr>
					  <td align="left">Tình trạng kho</td>
					  <td align="left"><input  name="product_status" id="product_status" / type ="text" value="<?php echo String::html_normalize(URL::get('product_status'));?>"></td>
					  <td align="left">&nbsp;</td>
					  <td align="left">&nbsp;</td>
					  <td align="left">Hệ ĐH</td>
					  <td align="left"><select  name="os_id" id="os_id" class="select-large"><?php
					if(isset($this->map['os_id_list']))
					{
						foreach($this->map['os_id_list'] as $key=>$value)
						{
							echo '<option value="'.$key.'"';
							echo '>'.$value.'</option>';
					...
					?><script type="text/javascript">getId('os_id').value = "<?php echo addslashes(URL::get('os_id',isset($this->map['os_id'])?$this->map['os_id']:''));?>";</script>
	</select></td>
					  </tr>
					<tr>
					  <td align="left" class="price-label">Giá gốc</td>
					  <td align="left"><input  name="public_price" id="public_price" / type ="text" value="<?php echo String::html_normalize(URL::get('public_price'));?>"></td>
					  <td align="left">&nbsp;</td>
					  <td align="left">&nbsp;</td>
					...
					<tr>
					  ...
					  <td align="left"><input  name="discount" id="discount" style="width:30px" / type ="text" value="<?php echo String::html_normalize(URL::get('discount'));?>">
					    %</td>
					  <td align="left">&nbsp;</td>
					  <td align="left">&nbsp;</td>
					  <td align="left">Vị trí</td>
					  <td align="left"><input  name="position" id="position" / type ="text" value="<?php echo String::html_normalize(URL::get('position'));?>"></td>
					  </tr>
					<tr>
					  <td align="left" class="price-label">Giá bán</td>
					  <td align="left"><input  name="price" id="price" / type ="text" value="<?php echo String::html_normalize(URL::get('price'));?>"></td>
						<td align="left">&nbsp;</td>
						<td align="left">&nbsp;</td>
						<td align="left">&nbsp;</td>
						<td align="left">&nbsp;</td>
					...
					<tr>
					  ...
					  <td align="left"><input  name="installment_price" id="installment_price" / type ="text" value="<?php echo String::html_normalize(URL::get('installment_price'));?>"></td>
					  <td align="left">&nbsp;</td>
					  <td align="left">&nbsp;</td>
					  <td align="left">&nbsp;</td>
					  <td align="left">&nbsp;</td>
...
<br>
					...
					<tr>
						...
						<div class="tab-page" id="tab-page-category">
							...
							<div class="form_input">
								 <input  name="name" id="name" style="width:60%;border:1px solid #CCCCCC;"  / type ="text" value="<?php echo String::html_normalize(URL::get('name'));?>">
							</div>
      	...
      	<div id="panel">
            ...
            <input  name="accessories" id="accessories" style="width:300px;" / type ="text" value="<?php echo String::html_normalize(URL::get('accessories'));?>"><br />
          ...
          <div id="panel_6" class="panel"  style="margin-top:0px;"><h2>Tags</h2>
         		<div>
            	<textarea  name="tags" id="tags" style="width:90%;" rows="5"><?php echo String::html_normalize(URL::get('tags',''));?></textarea>
          ...
          <table cellpadding="4" cellspacing="0" width="100%" border="1" bordercolor="#E9E9E9">	
              <tr valign="top">
                <td width="30%" align="right"><?php echo Portal::language('image_url');?></td>
                  ...
                  <?php 
				if((Url::get('image_url') and file_exists(Url::get('image_url'))))
				{?>
          ...
          <div id="panel_8" class="panel"  style="margin-top:8px;overflow:hidden;"><h2>Thư viện ảnh</h2>
              ...
              <?php 
				if((Url::get('item_image_url1')))
				{?>[<a href="<?php echo Url::build_current(array('cmd'=>'unlink_item_image','link'=>Url::get('item_image_url1'),'id'));?>" onclick="jQuery('#delete_image_url').html('');" style="color:#FF0000">Xóa</a>] <?php }else{ ?><input type="file" name="item_image_url1" id="item_image_url1" />
				<?php
				}
				?></li>
              <li><img src="<?php echo Url::get('item_image_url2');?>" width="50" onclick="window.open(this.src)" />Ảnh số 02 
              <?php 
				if((Url::get('item_image_url2')))
				{?>[<a href="<?php echo Url::build_current(array('cmd'=>'unlink_item_image','link'=>Url::get('item_image_url2'),'id'));?>" onclick="jQuery('#delete_image_url').html('');" style="color:#FF0000">Xóa</a>] <?php }else{ ?><input type="file" name="item_image_url2" id="item_image_url2" />
				<?php
				}
				?></li>
              <li><img src="<?php echo Url::get('item_image_url3');?>" width="50" onclick="window.open(this.src)" />Ảnh số 03 
              <?php 
				if((Url::get('item_image_url3')))
				{?>[<a href="<?php echo Url::build_current(array('cmd'=>'unlink_item_image','link'=>Url::get('item_image_url3'),'id'));?>" onclick="jQuery('#delete_image_url').html('');" style="color:#FF0000">Xóa</a>] <?php }else{ ?><input type="file" name="item_image_url3" id="item_image_url3" />
				<?php
				}
				?></li>
              <li><img src="<?php echo Url::get('item_image_url4');?>" width="50" onclick="window.open(this.src)" />Ảnh số 04 
              <?php 
				if((Url::get('item_image_url4')))
				{?>[<a href="<?php echo Url::build_current(array('cmd'=>'unlink_item_image','link'=>Url::get('item_image_url4'),'id'));?>" onclick="jQuery('#delete_image_url').html('');" style="color:#FF0000">Xóa</a>] <?php }else{ ?><input type="file" name="item_image_url4" id="item_image_url4" />
				<?php
				}
				?></li>
              <li><img src="<?php echo Url::get('item_image_url5');?>" width="50" onclick="window.open(this.src)" />Ảnh số 05
              <?php 
				if((Url::get('item_image_url5')))
				{?>[<a href="<?php echo Url::build_current(array('cmd'=>'unlink_item_image','link'=>Url::get('item_image_url5'),'id'));?>" onclick="jQuery('#delete_image_url').html('');" style="color:#FF0000">Xóa</a>] <?php }else{ ?><input type="file" name="item_image_url5" id="item_image_url5" />
				<?php
				}
				?></li>
              <li><img src="<?php echo Url::get('item_image_url6');?>" width="50" onclick="window.open(this.src)" />Ảnh số 06 
              <?php 
				if((Url::get('item_image_url6')))
				{?>[<a href="<?php echo Url::build_current(array('cmd'=>'unlink_item_image','link'=>Url::get('item_image_url6'),'id'));?>" onclick="jQuery('#delete_image_url').html('');" style="color:#FF0000">Xóa</a>] <?php }else{ ?><input type="file" name="item_image_url6" id="item_image_url6" />
				<?php
				}
				?></li>
              <li><img src="<?php echo Url::get('item_image_url7');?>" width="50" onclick="window.open(this.src)" />Ảnh số 07 
              <?php 
				if((Url::get('item_image_url7')))
				{?>[<a href="<?php echo Url::build_current(array('cmd'=>'unlink_item_image','link'=>Url::get('item_image_url7'),'id'));?>" onclick="jQuery('#delete_image_url').html('');" style="color:#FF0000">Xóa</a>] <?php }else{ ?><input type="file" name="item_image_url7" id="item_image_url7" />
				<?php
				}
				?></li>
              <li><img src="<?php echo Url::get('item_image_url8');?>" width="50" onclick="window.open(this.src)" />Ảnh số 08
              <?php 
				if((Url::get('item_image_url8')))
				{?>[<a href="<?php echo Url::build_current(array('cmd'=>'unlink_item_image','link'=>Url::get('item_image_url8'),'id'));?>" onclick="jQuery('#delete_image_url').html('');" style="color:#FF0000">Xóa</a>] <?php }else{ ?><input type="file" name="item_image_url8" id="item_image_url8" />
				<?php
				}
				?></li>
              <li><img src="<?php echo Url::get('item_image_url8');?>" width="50" onclick="window.open(this.src)" />Ảnh số 09 
              <?php 
				if((Url::get('item_image_url9')))
				{?>[<a href="<?php echo Url::build_current(array('cmd'=>'unlink_item_image','link'=>Url::get('item_image_url9'),'id'));?>" onclick="jQuery('#delete_image_url').html('');" style="color:#FF0000">Xóa</a>] <?php }else{ ?><input type="file" name="item_image_url9" id="item_image_url9" />
				<?php
				}
				?></li>
            </ul>
