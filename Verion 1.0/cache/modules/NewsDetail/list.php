...
jQuery(document).ready(function(){
  ...
  <div class="nav">
      <ul class="left">
          ...
          <li><span> » </span></li>
          <li><a href="tin-bong-da">Tin tức</a></li>
          <?php 
				if((Url::get('name_id')))
				{?>
          <li><span> » </span></li>
      ...
      <ul class="right">
          ...
          <?php if(User::can_edit(MODULE_NEWSADMIN,ANY_CATEGORY)){?><li>Lượt xem: <?php echo $this->map['hitcount'];?></li><?php }?>
      </ul>
  </div>
  <div class="content-r">
  		<div class="m-adv">
      ...
      <div class="news_detail">
          <h1><?php echo $this->map['name'];?> <?php if(User::can_edit(MODULE_NEWSADMIN,ANY_CATEGORY) or Session::get('user_id') == $this->map['user_id']){?><a target="_blank" href="<?php echo (Session::get('user_id') == $this->map['user_id'] and $this->map['show_author'])?('dang-tin.html?do=edit&id='.$this->map['id'].''):'?page=news_admin&cmd=edit&id='.$this->map['id'];?>">[Sửa]</a><?php }?></h1>
					<?php echo $this->map['description'];?>
          <br clear="all">
      </div><!--End .news_detail-->
      
      	<?php 
				if(($this->map['author'] and $this->map['show_author']))
				{?>
        <p style="color:#333;font-size:11px;padding:5px 0px 5px 0px;text-align:right">Bài viết thể hiện quan điểm cá nhân của độc giả: <strong><?php echo $this->map['author'];?></strong></p>
         <?php }else{ ?>
      	<p style="color:#999;font-size:11px;padding:5px 0px 5px 0px;"><strong>Tuyên bố trách nhiệm</strong>: Bài viết được lấy nguyên văn theo nguồn tin nêu trên. Mọi thắc mắc về nội dung bài viết xin liên hệ trực tiếp với tác giả. Chúng tôi sẽ sửa, hoặc xóa bài viết nếu nhận được yêu cầu từ phía tác giả hoặc nếu bài gốc được sửa, hoặc xóa, nhưng vẫn bảo đảm nội dung được lấy nguyên văn từ bản gốc.</p>
