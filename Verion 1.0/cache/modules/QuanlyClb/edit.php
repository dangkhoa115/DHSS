...
<span style="display:none">
	<span id="mi_clb_sample">
      ...
      <span class="multi-edit-input"><select  name="mi_clb[#xxxx#][mua_giai_id]" style="width:100px;" class="multi-edit-text-input" id="mua_giai_id_#xxxx#"><?php echo $this->map['mua_giai_options'];?></select></span>
