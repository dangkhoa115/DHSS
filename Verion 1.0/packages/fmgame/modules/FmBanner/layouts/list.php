   	 ...
   	 <div class="col-xs-12">
          ...
          <div class="col-xs-4 text-right">
            <div class="dropdown" style="float:right;">
                ...
                HLV: <strong>[[|full_name|]]</strong>
                <span class="caret"></span>
              </button>
              <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                <li> <a href="trang-ca-nhan-dhss.html">ID: <?php echo Session::get('user_id');?></a></li>
                <li><a href="trang-ca-nhan-dhss.html" class="username">HLV: <strong>[[|full_name|]]</strong></a></li>
            	...
            	<a href="?page=nhan-thuong">Nhận thưởng</a>
           		<a href="tin-nhan.html" class="message <?php echo [[=number_message=]]?'unread':'';?>" title="[[|new_message|]]"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> <span id="message" class="badge">[[|number_message|]]</span></a>
