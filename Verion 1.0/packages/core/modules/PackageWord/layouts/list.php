...
?>
	...
	if(User::can_delete()){?>
	<td class="form_title_button" nowrap="nowrap">
		<a  onclick="if(confirm('[[.delete_confirm_question.]]?')){ListPackageWordForm.cmd.value='delete';ListPackageWordForm.submit();}"><img alt="" src="<?php echo Portal::template('core').'/images/buttons/';?>delete.gif"/><br />[[.Delete.]]</a></td><?php }
	?>
	</tr>
	</table>
...
<div class="form_bound">
	...
	?>
	<p>
	<a ><font size="+1"><b>[[.module_words_of.]] [[|module_name|]]</b></font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo URL::build_current();?>"><font size="+1">[[.all_words.]]</font></a>
	</p>
	<?php
	}?>
