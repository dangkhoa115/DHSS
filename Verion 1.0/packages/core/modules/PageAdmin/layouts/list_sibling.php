...
<table cellpadding="0" width="100%"><tr><td  class="form_title"><img src="skins/default/images/buttons/<?php echo $action;?>_button.gif" align="absmiddle" alt=""/><?php echo $title;?></td><?php if(URL::get('cmd')=='delete'){?><td class="form_title_button"><a  onclick="ListPageAdminSiblingForm.submit();"><img src="skins/default/images/buttons/delete_button.gif" style="text-align:center" alt=""/><br />[[.Delete.]]</a></td><td class="form_title_button"><a href="<?php echo URL::build_current(array('portal_id','package_id'=>isset($_GET['package_id'])?$_GET['package_id']:'',  
	...
	'name'=>isset($_GET['name'])?$_GET['name']:'',    
				...
				<a  onclick="ListPageAdminSiblingForm.cmd.value='delete';ListPageAdminSiblingForm.submit();"><img src="skins/default/images/buttons/delete_button.gif" alt=""/><br />[[.Delete.]]</a></td><?php }}?>
