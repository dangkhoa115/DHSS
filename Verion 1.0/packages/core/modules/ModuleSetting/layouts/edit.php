...
<table cellpadding="0" width="100%"><tr><td  class="form_title"><?php echo $title;?></td>
		<td class="form_title_button"><a  onclick="EditModuleSettingForm.submit();"><img alt="" src="skins/default/images/buttons/save.jpg" class="icon_cmd"/>[[.save.]]</a></td>
		<td class="form_title_button"><a  onclick="location='<?php echo URL::build_current();?>';"><img alt="" src="skins/default/images/buttons/back.jpg" class="icon_cmd"/>[[.back.]]</a></td>
		<?php if($action=='edit'){?><td class="form_title_button"><a  onclick="location='<?php echo URL::build_current(array('cmd'=>'delete','id'));?>';"><img alt="" src="skins/default/images/buttons/delete.jpg" class="icon_cmd"/>[[.Delete.]]</a></td><?php }?>
	...
	<table width="100%" border="0" cellspacing="4" cellpadding="4">
	  <tr>
		<td colspan="2" align="right" style="width:100%"><a  onclick="Javascript:Element.toggle('advanced_detail');" class="button_link">Show advanced detail </a></td>
		</tr>
	  <tr>
    <td style="width:100%">
