...
<table cellpadding="0" width="100%"><tr><td  class="form_title"><?php echo $title;?></td><?php 
			if(URL::get('cmd')=='delete'){?><td class="form_title_button"><a  onclick="ModuleSettingForm.submit();"><img alt="" src="skins/default/images/buttons/delete.jpg" style="text-align:center"/><br />[[.Delete.]]</a></td><?php 
			}else{ 
