...
<form method="post" name="SearchModuleSettingForm" action="?<?php echo htmlentities($_SERVER['QUERY_STRING']);?>">
	...
	<?php 
		if(URL::get('cmd')=='delete'){?><td class="form_title_button"><a  onclick="$('cmd').cmd='delete';ListModuleSettingForm.submit();"><img src="skins/default/images/buttons/delete.jpg" alt="" width="16" height="16" class="icon_cmd"/>[[.Delete.]]</a></td>
			...
			if(User::can_delete()){?><td class="form_title_button"><a  onclick="ListModuleSettingForm.cmd.value='delete';ListModuleSettingForm.submit();"><img alt="Delete" src="skins/default/images/buttons/delete.jpg" class="icon_cmd"/>[[.Delete.]]</a></td><?php }
		}?></tr></table>
</form>	
<div class="form_bound">
	<div class="form_content">
		...
		<td width="100%">
			[[.select.]]:&nbsp;
			<a  onclick="select_all_checkbox(document.ListModuleSettingForm,'ModuleSetting',true,'<?php echo Portal::get_setting('crud_list_item_selected_bgcolor','#FFFFEC');?>','<?php echo Portal::get_setting('crud_item_bgcolor','white');?>');">[[.select_all.]]</a>&nbsp;
			<a  onclick="select_all_checkbox(document.ListModuleSettingForm,'ModuleSetting',false,'<?php echo Portal::get_setting('crud_list_item_selected_bgcolor','#FFFFEC');?>','<?php echo Portal::get_setting('crud_item_bgcolor','white');?>');">[[.select_none.]]</a>
			<a  onclick="select_all_checkbox(document.ListModuleSettingForm,'ModuleSetting',-1,'<?php echo Portal::get_setting('crud_list_item_selected_bgcolor','#FFFFEC');?>','<?php echo Portal::get_setting('crud_item_bgcolor','white');?>');">[[.select_invert.]]</a>
		</td>
		<td>
			<a name="bottom_anchor" ><img alt="" src="<?php echo Portal::template('core');?>/images/top.gif" title="[[.top.]]" border="0" alt="[[.top.]]"></a>
		</td>
		</tr></table>
