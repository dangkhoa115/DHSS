...
<table cellpadding="0" width="100%"><tr valign="bottom"><td  class="form_title"><img src="skins/default/images/buttons/<?php echo $action;?>_button.gif" align="absmiddle" alt=""/><?php echo $title;?></td><?php 
	if(URL::get('cmd')=='delete'){?><td class="form_title_button"><a  onclick="ListPackageAdminForm.submit();"><img src="skins/default/images/buttons/delete_button.gif" style="text-align:center" alt=""/><br />[[.Delete.]]</a></td>
	...
	if(User::can_delete()){?><td class="form_title_button">
				<a  onclick="ListPackageAdminForm.cmd.value='delete';ListPackageAdminForm.submit();"><img src="skins/default/images/buttons/delete_button.gif" alt=""/><br />[[.Delete.]]</a></td><?php }}?>
