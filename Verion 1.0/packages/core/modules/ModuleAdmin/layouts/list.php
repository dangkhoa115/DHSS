...
<table cellpadding="0" width="100%"><tr><td  class="form_title"><img src="skins/default/images/buttons/<?php echo $action;?>_button.gif" align="absmiddle" alt=""/><?php echo $title;?></td><?php 
		if(URL::get('cmd')=='delete'){?><td class="form_title_button"><a  onclick="ListModuleAdminForm.submit();"><img src="skins/default/images/buttons/delete_button.gif" style="text-align:center" alt=""/><br />[[.Delete.]]</a></td>
		...
		<td width="100%">
			...
			<tr>
				<td width="100%">
                    ...
                    ([[.total.]] <strong>[[|total|]]</strong> modules)
					</form>
					<a name="top_anchor"></a>
