...
?><div class="form_bound">
	<table cellpadding="0" width="100%"><tr><td  class="form_title"><img src="skins/default/images/buttons/<?php echo $action;?>_button.gif" align="absmiddle" alt=""/><?php echo $title;?> module [[|name|]]</td><td class="form_title_button"><a  onclick="EditModuleCodeAdminForm.submit();"><img src="skins/default/images/buttons/save_button.gif" style="text-align:center"/><br />[[.save.]]</a></td><td>&nbsp;</td>
