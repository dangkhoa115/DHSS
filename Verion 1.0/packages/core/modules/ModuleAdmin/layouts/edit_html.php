...
<table cellpadding="0" width="100%"><tr><td  class="form_title"><img src="skins/default/images/buttons/<?php echo $action;?>_button.gif" align="absmiddle" alt=""/><?php echo $title;?> module [[|name|]]</td><td class="form_title_button"><a  onclick="EditModuleHTMLAdminForm.submit();"><img src="skins/default/images/buttons/save_button.gif" style="text-align:center"/><br />[[.save.]]</a></td><td>&nbsp;</td>
		...
		<?php if($action=='edit'){?><td class="form_title_button">
			<a  onclick="location='<?php echo URL::build_current(array('cmd'=>'edit','id'));?>';"><img src="skins/default/images/buttons/edit_button.gif"/><br />[[.Edit.]]</a></td><?php }?>
		<td class="form_title_button">
