...
class Draw
{
	static function int_to_words($x)
	 {
	...
	static function fieldset_begin()
	{
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	static function hover($color='#EAF1FB')
	{
	...
	static function button($title,$url=false,$tooltip=false,$onsubmit=false,$form_name=false, $target=false, $font_color="#143B80")
	{
		if($onsubmit)
		{
	...
	static function begin_round_table()
	{
		echo '<div class="body">';
		echo '<div class="main">';
	}
	static function end_round_table()
	{
		echo '</div>';
		echo '</div>';
	}
	static function title_label($name,$label)
	{
