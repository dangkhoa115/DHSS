...
function simple_mce(id_list)
{
	tinyMCE.init({
		mode : "exact",
		elements:id_list,
		plugins : "fullscreen,youtube,insert_image",
		theme_advanced_toolbar_location : "top",
		document_base_url:"",
		theme_advanced_buttons1 :"formatselect,bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,search,replace,|,bullist,numlist,|,youtube,image,removeformat,fullscreen",
...
function advance_mce(id_list)
{
	tinyMCE.init({
		...
		document_base_url:"",
		elements:id_list,
		plugins : "insert_image,safari,spellchecker,pagebreak,style,layer,table,save,advhr,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,preview,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template,imagemanager,filemanager,youtube",
		...
		theme_advanced_buttons3 : "tablecontrols,|,hr,visualaid,|,sub,sup,|,charmap,emotions,iespell,youtube,advhr,|,print,|,ltr,rtl,|,fullscreen",
