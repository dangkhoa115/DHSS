...
<div class="sign-in-wrapper">
	<div class="body">
		...
		<div class="sign-in-content">
			<ul>
            <h2>[[.welcome.]] : <?php echo Session::get('user_id')?></a></h2>
            <!--IF:cond([[=kind=]]==2)-->
            ...
            <!--/IF:cond-->
            <a class="sign-in-link" href="<?php echo URL::build('sign_out');?>&href=?<?php echo urlencode($_SERVER['QUERY_STRING'])?>">[[.logout.]]</a>
			</ul>
		</div>
	</div>
</div>
