...
<fieldset id="toolbar">
	<legend>[[.utils.]]</legend>
	<div id="toolbar-title">[[.Report_change_room_rate.]]</div>
...
<table cellpadding="0" cellspacing="6" width="100%">
		<tr>
			<td width="100%">
				...
				<div><input name="search" type="submit"  value="[[.search.]]" id="search"></div>
			</td>
		</tr>
	</table>
	<table cellpadding="6" cellspacing="0" width="100%" style="#width:99%;margin-top:8px;" border="1" bordercolor="#E7E7E7" align="center">
	  <tr style="background-color:#F0F0F0">
		...
		<th width="14%" align="left"><a>[[.Hotel.]]</a></th>
		<th width="14%" align="left"><a>[[.Website.]]</a></th>
		<th width="14%" align="left"><a>[[.Edit_link.]]</a></th>
		<th width="10%" align="left"><a>[[.Edited_by.]]</a></th>
	...
	<!--LIST:items-->
	  <tr valign="middle" <?php Draw::hover(Portal::get_setting('crud_item_hover_bgcolor','#FFFFDD'));?> style="cursor:hand;<?php if($i%2){echo 'background-color:#F9F9F9';}?>" id="Category_tr_[[|items.id|]]">
		...
		<td nowrap="nowrap">[[|items.hotel_name|]]</td>
		<td nowrap="nowrap"><!--IF:webiste([[=items.website=]])--><a href="[[|items.website|]]">[[|items.website|]]</a><!--/IF:website--></td>
		<td nowrap="nowrap"><a target="_blank" href="<?php echo Url::build('hotel',array('hotel_zone_id'=>[[=items.zone_name_id=]],'name_id'=>[[=items.name_id=]]),REWRITE); ?>">[[.View.]]</a></td>
		<td>[[|items.user_id|]]</td>
		<td>[[|items.type|]]</td>
