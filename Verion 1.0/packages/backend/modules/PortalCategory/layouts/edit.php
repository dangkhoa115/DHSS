			...
			<tr>
				...
				<div class="tab-page" id="tab-page-category-[[|languages.id|]]">
					...
					<div class="form_input">
						<input name="name_[[|languages.id|]]" type="text" id="name_[[|languages.id|]]" style="width:50%" >
					</div>
		...
		<div id="panel_1" style="margin-top:8px;">
			...
			<table cellpadding="4" cellspacing="0" width="100%" border="1" bordercolor="#E9E9E9" style="margin-top:2px;">
				<tr>
				  ...
				  <td><input name="site_title" type="text" id="site_title" class="input-large"></td>
				  </tr>
				<tr>
					<td>[[.parent_name.]]</td>
				...
				<tr>
					<td>[[.type.]]</td>
					<td><select name="type" id="type"  onchange="jQuery('#extra_type').val(this.value)"  class="select-large"></select></td>
				</tr>
				<tr>
					<td>[[.url.]]</td>
