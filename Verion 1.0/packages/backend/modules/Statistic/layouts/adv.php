<fieldset id="toolbar">
	...
	<div id="toolbar-info">[[.statistic_advertisment.]]</div>
...
<table  cellpadding="6" cellspacing="0" width="100%" style="#width:99%;margin-top:4px;" border="1" bordercolor="#E7E7E7" align="center">
  ...
  <tr style="cursor:hand;<?php if($i%2){echo 'background-color:#F9F9F9';}?>">
	<td><?php echo ++$i;?></td>
	<td><a href="<?php  echo Url::build('manage_advertisment',array('id'=>[[=items.id=]],'cmd'=>'advertisment'));?>"><img src="skins/default/images/buttons/edit.jpg" title="[[.edit.]]"></a>&nbsp;[[|items.name|]]</td>
	<td>[[|items.url|]]</td>
