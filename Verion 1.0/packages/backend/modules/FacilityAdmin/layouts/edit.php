<span style="display:none">
	<span id="mi_facility_group_sample">
		<span id="input_group_#xxxx#" style="width:100%;text-align:left;">
			...
			<span class="multi-input">
				<select  name="mi_facility_group[#xxxx#][facility_group_id]"  id="facility_group_id_#xxxx#" style="padding:3px;">
					[[|facility_group|]]
				</select>
			</span>
			
			<span class="multi-input"><span style="width:20px; margin-left:10px;">
...
<fieldset id="toolbar">
	...
	<table>
	  <tbody>
		<tr>
		  <td id="toolbar-save"  align="center"><a onclick="FacilityAdmin.submit();"> <span title="Edit"> </span> [[.Save.]] </a> </td>
...
<form name="FacilityAdmin" id="FacilityAdmin" method="post" enctype="multipart/form-data">
<div class="facility-admin-bound">
	<fieldset>
		<legend>[[.Facility.]]</legend>
			<span id="mi_facility_group_all_elems" style="text-align:left;">
				<span style="background:#CCCCCC; ">
					...
					<span class="multi-input_header"><span style="width:125px;float:left; font-weight:bold">[[.Group.]]</span></span>
