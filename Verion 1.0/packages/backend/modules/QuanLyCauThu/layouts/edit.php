...
<span style="display:none">
	<span id="mi_cau_thu_sample">
      ...
      <span class="multi-edit-input"><select  name="mi_cau_thu[#xxxx#][clb_id]" style="width:100px;" class="multi-edit-text-input" id="clb_id_#xxxx#">[[|clb_options|]]</select></span>
      <span class="multi-edit-input"><select  name="mi_cau_thu[#xxxx#][mua_giai_id]" style="width:100px;font-size:11px;" class="multi-edit-text-input mua-giai" id="mua_giai_id_#xxxx#">[[|mua_giai_options|]]</select></span>
      <span class="multi-edit-input"><select  name="mi_cau_thu[#xxxx#][vi_tri_id]" style="width:80px;font-size:11px;" class="multi-edit-text-input" id="vi_tri_id_#xxxx#">[[|vi_tri_options|]]</select></span>
      ...
      <span class="multi-edit-input"><input  name="mi_cau_thu[#xxxx#][can_nang]" style="width:40px;" class="multi-edit-text-input" type="text" id="can_nang_#xxxx#"></span>
			<span class="multi-edit-input"><select  name="mi_cau_thu[#xxxx#][quoc_tich_id]" style="width:80px;" class="multi-edit-text-input" id="quoc_tich_id_#xxxx#">[[|quoc_tich_options|]]</select></span>
...
<table cellspacing="0" width="100%" class="multi-item-table">
  ...
  <div class="navi-list" style="float:left;width:160px;">
    ...
    <ul>
    	<li <?php echo !Url::get('clb_id')?'class="active"':'';?>><a href="<?php echo Url::build_current(array())?>">Tất cả<span>([[|total|]])</span></a></li>
    	<!--LIST:clbs-->
    	<li <?php echo (Url::iget('clb_id')==[[=clbs.id=]])?'class="active"':'';?>><a href="<?php echo Url::build_current(array('clb_id'=>[[=clbs.id=]]))?>">[[|clbs.ten|]] <span>([[|clbs.sl_cau_thu|]])</span></a></li>
      <!--/LIST:clbs-->
    </ul>
  </div>
	...
	?>
  <tr>
  	<td><input name="keyword" type="text" id="keyword" placeholder="Nhập tên cầu thủ" /> <input name="search" type="submit" value="Tìm kiếm" /></td>
  </tr>
  <tr valign="top">
		<td>
      ...
      <span id="mi_cau_thu_all_elems">
        <span style="white-space:nowrap;">
          ...
          <span class="multi-edit-input header" style="width:100px;">Mùa giải<br><select name="move_mua_giai_id" id="move_mua_giai_id" onChange="jQuery('.mua-giai').val(this.value)"></select></span>          
