...
<?php if(Form::$current->is_error()){echo Form::$current->error_messages();}?>
	<form name="MakeSlideMediaAdminForm" method="post" action="?<?php echo htmlentities($_SERVER['QUERY_STRING']);?>">
							...
							<!--LIST:items-->
								<div style="float:left;width:78px;margin:8px;border:1px solid #E7E7E7;padding:2px;padding-bottom:0px;">
									...
									<?php 
										...
										{
											echo '<img src="'.[[=items.image_url=]].'" width="78" height="70" onerror="this.src=\'skins/default/images/no_image.gif\'">';
										}
									?>
									</div>
									<div>
	...
	<table  width="100%" cellpadding="6" cellspacing="0" style="background-color:#F0F0F0;border:1px solid #E7E7E7;#width:99%" align="center">
	  <tr>
		<td>
			[[.select.]]:&nbsp;
			<a onclick="select_all_checkbox(document.MakeSlideMediaAdminForm,'MakeSlideMediaAdmin',true,'#FFFFEC','white');">[[.select_all.]]</a>&nbsp;
			<a onclick="select_all_checkbox(document.MakeSlideMediaAdminForm,'MakeSlideMediaAdmin',false,'#FFFFEC','white');">[[.select_none.]]</a>
			<a onclick="select_all_checkbox(document.MakeSlideMediaAdminForm,'MakeSlideMediaAdmin',-1,'#FFFFEC','white');">[[.select_invert.]]</a>		
		</td>
	</table>
