<?php
class ListMediaAdminForm extends Form
{
	function ListMediaAdminForm()
	{
		Form::Form('ListMediaAdminForm');
	...
	function draw()
	{
		$cond = '1 and media.type="'.Url::get('type').'"';
		...
		$total = MediaAdminDB::get_total_item($cond);
