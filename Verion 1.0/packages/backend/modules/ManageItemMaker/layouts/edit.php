...
<span style="display:none">
	<span id="mi_maker_sample">
     ...
     <span class="multi-edit-input">
				<span style="width:40px;"><input  name="mi_maker[#xxxx#][id]" type="text" id="id_#xxxx#" class="multi-edit-text-input" style="width:40px;text-align:right;" value="(auto)" tabindex="-1"></span>
			</span> 
     <span class="multi-edit-input">
          <span style="width:80px;"><img id="img_icon_url_#xxxx#" style="width:80px;" alt=""></span>
			</span>
      <span class="multi-edit-input">
      ...
      <span class="multi-edit-input">
				<input  name="mi_maker[#xxxx#][selected]" class="multi-edit-text-input" type="checkbox" id="selected_#xxxx#" value="1"  tabindex="3" style="margin-right:100px;">
			</span>
...
<div align="center">
<form name="EditManageItemMakerForm" method="post" enctype="multipart/form-data">
	...
	<tr valign="top" bgcolor="#FFFFFF">
        ...
        <table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
            <tr>
                ...
                <?php if(User::can_add(false,ANY_CATEGORY)){?><td width="1%"><a href="javascript:void(0)" onclick="EditManageItemMakerForm.submit();"  class="button-medium-save">[[.save.]]</a></td><?php }?>
	...
	?><tr bgcolor="#EFEFEF" valign="top">
      ...
      <span id="mi_maker_all_elems">
        <span style="white-space:nowrap;">
          <span class="multi-edit-input_header"><span style="width:20px;float:left;"><input type="checkbox" value="1" onclick="mi_select_all_row('mi_maker',this.checked);"></span></span>
          ...
          <span class="multi-edit-input_header"><span style="width:155px;float:left;">Tên hãng</a></span></span>
          <span class="multi-edit-input_header"><span style="width:200px;">Hiển thị trên menu</span></span>
