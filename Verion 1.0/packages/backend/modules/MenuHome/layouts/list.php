<div class="home-menu-bound">
	...
	<div class="home-menu-function-bound">
		...
		<!--LIST:child-->
			...
			<!--ELSE-->
			<div class="home-menu-item" onclick="window.location='[[|child.url|]]'">
				<div class="home-menu-item-img">
				<!--IF:cond([[=child.icon_url=]] and file_exists([[=child.icon_url=]]))-->
				<img src="[[|child.icon_url|]]" />
				<!--ELSE-->
				<img src="skins/default/images/menu/folder.png" />
				<!--/IF:cond-->
				</div>
				<div class="home-menu-item-name">
					<a href="<!--IF:cond3([[=child.url=]])-->[[|child.url|]]<!--ELSE--><!--/IF:cond3-->"><?php echo Portal::language()==1?[[=child.name_1=]]:[[=child.name_2=]]; ?></a>
				</div>
			</div>
			<!--/IF:cond10-->
