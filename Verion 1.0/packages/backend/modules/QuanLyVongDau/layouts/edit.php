...
<span style="display:none">
	<span id="mi_vong_dau_sample">
      ...
      <span class="multi-edit-input"><input  name="mi_vong_dau[#xxxx#][den_ngay_sms]" style="width:125px;" class="multi-edit-text-input" type="text" id="den_ngay_sms_#xxxx#"></span>
			<span class="multi-edit-input"><select  name="mi_vong_dau[#xxxx#][mua_giai_id]" style="width:100px;" class="multi-edit-text-input" id="mua_giai_id_#xxxx#">[[|mua_giai_options|]]</select></span>
...
<table cellspacing="0" width="100%" class="multi-item-table">
	...
	?>
  <tr>
  	<td><input name="keyword" type="text" id="keyword" placeholder="Nhập vòng đấu" /> <input name="search" type="submit" value="Tìm kiếm" /></td>
  </tr>
  <tr valign="top">
		<td>
