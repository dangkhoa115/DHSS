...
<table cellspacing="0" width="100%" class="multi-item-table">
  ...
  <tr>
  	<td>
    	<div class="search" style="float:left;"><input name="keyword" type="text" id="keyword" placeholder="Nhập tên đội" /> <input name="search" type="submit" value="Tìm kiếm" /> /  Tổng số bàn thắng vòng đấu: [[|ban_thang|]]</div>
