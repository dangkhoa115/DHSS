...
<form name="ListSurveyAdminForm" method="post" action="?<?php echo htmlentities($_SERVER['QUERY_STRING']);?>">
	...
	<table width="100%" cellpadding="6" cellspacing="0" style="background-color:#F0F0F0;border:1px solid #E7E7E7;height:8px;#width:99%" align="center">
		...
		<td width="50%">
			[[.select.]]:&nbsp;
			<a onclick="select_all_checkbox(document.ListSurveyAdminForm,'SurveyAdmin',true,'#FFFFEC','white');">[[.select_all.]]</a>&nbsp;
			<a onclick="select_all_checkbox(document.ListSurveyAdminForm,'SurveyAdmin',false,'#FFFFEC','white');">[[.select_none.]]</a>
			<a onclick="select_all_checkbox(document.ListSurveyAdminForm,'SurveyAdmin',-1,'#FFFFEC','white');">[[.select_invert.]]</a>		</td>
