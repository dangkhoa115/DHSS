...
<span style="display:none">
	<span id="mi_lich_su_sample">
      ...
      <span class="multi-edit-input"><input  name="mi_lich_su[#xxxx#][cao_nhat_doi]" type="checkbox" id="cao_nhat_doi_#xxxx#" value="1" style="width:40px;"></span>
      	...
      	<!--IF:cond(![[=cau_thu=]] or Url::get('doi_cao_nhat')==1)-->
...
<table cellspacing="0" width="100%" class="multi-item-table">
  ...
  <tr>
  	<td>
    	<select name="vong_dau_id" id="vong_dau_id" class="form-control" onChange="EditQuanLyLichSuCauThuForm.submit();"></select>
    </td>
  </tr>
  <tr valign="top">
		<td>
    ...
    <div style="padding:5px;border:1px solid #999;border-radius:5px;background:#FFFBC9">
    	TOP vòng đấu: <!--IF:cond([[=cau_thu=]])--><strong>[[|cau_thu|]]</strong> ([[|diem|]] điểm) - [[|clb|]] (<a href="<?php echo Url::build_current(array('clb_id'=>[[=cao_nhat_clb_id=]],'vong_dau_id','doi_cao_nhat'=>1));?>">Thay đổi</a>)<!--ELSE-->Chưa có<!--/IF:cond-->
    </div>
    ...
    <input name="confirm_edit" type="hidden" id="confirm_edit" value="0" />
