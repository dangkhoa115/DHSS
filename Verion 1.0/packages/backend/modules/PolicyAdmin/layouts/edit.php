	...
	<span id="mi_policy_group_sample">
		<span id="input_group_#xxxx#" style="width:100%;text-align:left;">
			...
			<span class="multi-input">
				<input name="mi_policy_group[#xxxx#][name]" style="width:385px;" id="name_#xxxx#">
			</span>
			<span class="multi-input"><span style="width:20px;">
				<img src="skins/default/images/buttons/delete.gif" onClick="mi_delete_row($('input_group_#xxxx#'),'mi_policy_group','#xxxx#','group_');return false;" style="cursor:pointer;" align="top">
			</span>
			</span><br clear="all">
		</span>
	</span>
...
<fieldset id="toolbar">
	...
	<table>
	  <tbody>
		<tr>
		  <td id="toolbar-save"  align="center"><a onclick="PolicyAdmin.submit();"> <span title="Edit"> </span> [[.Save.]] </a> </td>
...
<form name="PolicyAdmin" id="PolicyAdmin" method="post" enctype="multipart/form-data">
<div class="policy-admin-bound">
	<fieldset>
		...
		<input type="button" value="   [[.add_item.]]   " onclick="mi_add_new_row('mi_policy_group');">
...
<script>
	mi_init_rows('mi_policy_group',
		<?php if(isset($_REQUEST['mi_policy_group']))
		{
			echo String::array2js($_REQUEST['mi_policy_group']);
		}
		else
		{
			echo '{}';
