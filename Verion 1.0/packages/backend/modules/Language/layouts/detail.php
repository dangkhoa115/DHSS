...
<table cellspacing="0" width="100%">
  <tr valign="top" >
	...
	<form name="LanguageForm" method="post" action="?<?php echo htmlentities($_SERVER['QUERY_STRING']);?>">
